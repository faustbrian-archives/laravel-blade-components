...
it('should format the given value', function (): void {
    ...
    assertMatchesSnapshot((new ShortCurrency('en-US'))->render()(['slot' => 10000000]));
    assertMatchesSnapshot((new ShortCurrency('en-US'))->render()(['slot' => 100000000]));
    assertMatchesSnapshot((new ShortCurrency('en-US'))->render()(['slot' => 1000000000]));
    assertMatchesSnapshot((new ShortCurrency('en-US'))->render()(['slot' => 10000000000]));
    assertMatchesSnapshot((new ShortCurrency('en-US'))->render()(['slot' => 100000000000]));
    assertMatchesSnapshot((new ShortCurrency('en-US'))->render()(['slot' => 1000000000000]));
});
